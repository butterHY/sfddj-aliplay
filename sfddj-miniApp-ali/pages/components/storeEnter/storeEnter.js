...
Component({
  ...
  methods: {
    ...
    moreShop() {
      ...
      my.uma.trackEvent('homepage_O2O_click', { type: 'storeList' });
      my.navigateTo({
    ...
    goShop(e) {
      ...
      my.uma.trackEvent('homepage_O2O_click', { type: 'store', shopId: shopId });
      my.navigateTo({
    ...
    goDetail(e) {
      ...
      my.uma.trackEvent('homepage_O2O_click', { type: 'goodsDetail', shopId, goodsId });
      my.navigateTo({
