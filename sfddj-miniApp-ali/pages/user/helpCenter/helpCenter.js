...
Page({
  ...
  data: {
    ...
    list2: [{
      ...
      title: '售后凭证说明',
      content: '提交售后申请时，为确保商家快速处理您的售后问题，请您如实描述您的商品问题并提供清晰可分辨商品问题的照片凭证，原则上如您无法提供真实有效的照片凭证，会导致商家无法正常受理您的售后申请。',
      image: '',
      open: false
    }, {
      title: '如何申请平台介入售后',
      content: '如您对商家售后处理有疑议，可在商家处理完毕后7天内申请平台介入。\r\n申请流程：“大当家商城”—“我的”—“我的订单”—点击对应商品订单进入“订单详情”—点击【商家已处理】进入处理详情--选择【平台介入】--正确填写申诉原因及照片凭证--【确认】提交，平台将尽快受理您的申诉。',
      image: '',
      open: false
    }, {
      title: '退款说明',
