...
Page({
  ...
  data: {
    ...
    list3: [{
      ...
      title: '商务合作',
      content: '商务合作请您在PC端浏览器搜索“年丰大当家”官网，点击“关于我们”下载招商信息模板，填写后请发送至招商邮箱：sfdadangjia@sf-express.com，如有合作意向，将有专人在7个工作日内回复您的邮件，如一直未收到回复邮件，则暂无合作意向。',
      image: '',
      open: false
    }, {
      title: '客服工作时间',
